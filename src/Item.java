...
public class Item extends Application {
    ...
    public void start(Stage stage) throws FileNotFoundException {
        ...
        details.setStyle(
                "-fx-control-inner-background: #2d3545; -fx-font: 16 verdana; -fx-text-fill: #c7c7ff; -fx-text-box-border: transparent; -fx-focus-color: transparent;");
        ...
        descript.setStyle(
                "-fx-control-inner-background: #2d3545; -fx-font: 14 verdana; -fx-text-fill: #c7c7ff; -fx-text-box-border: transparent; -fx-focus-color: transparent;");
